...
import { MerchantDiscountRateCreate, getMerchantDiscountRateData } from "../services/service";
                ...
                <div className="back-title flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                    ...
                    <div className="flex items-center justify-between w-full sm:hidden">
                        ...
                        <div className="flex flex-col items-center text-center">
                            <h1 className="header-title text-base">Merchant Discount Rate Management</h1>
                    ...
                    <div className="hidden sm:flex sm:justify-between sm:items-center w-full gap-[10px]">
                        ...
                        <div className="header-left flex items-center gap-[10px]">
                            ...
                            <div>
                                <h1 className="user-title">Merchant Discount Rate Management</h1>
            ...
            <div className="table-card">
                <div className="table-header">
                    <div className="flex items-center gap-2 primary-color">
                        ...
                        <p className="user-table-header">Existing Merchant Discount Rates</p>
                    </div>
                    <span className="table-subtext">
                        Total: {MerchantDiscountRates.length} MerchantDiscountRates
                    </span>
                </div>
                        ...
                        <tbody>
                            {MerchantDiscountRates.length > 0 ? (
                                ...
                                <tr>
                                    ...
                                    >
                                        No MerchantDiscountRates found.
                                    </td>
                                </tr>
                            )}
                        </tbody>
